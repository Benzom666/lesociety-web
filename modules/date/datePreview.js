    ...
    {!confirmPopup ? (
      ...
      <div className="inner_container">
        <div className=" d-md-none justify-content-around align-items-center login-text mb-0 mt-5 d-flex">
          ...
          <h6 className="m-0 text-white-50">CREATE A NEW DATE</h6>
          <IoIosClose className="" size={32} style={{color:" rgba(255, 255, 255, 0.5)"}} onClick={toggle} />
        </div>
        {/* {width < 768 && <h6 className="m-3 text-center">Date Preview</h6>} */}
      ...
      >
        <div className="inner_container create-date-wrap" style={{maxWidth:"1400px",margin:"0px" ,padding:"0px"}}>
