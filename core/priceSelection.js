...
const PriceSelection = (props) => {
    ...
    const { onlyLabel, input, meta: { warning, touched, error }} = props  
            ...
            {options && options.map((option, index) => {
                return <div className="radio_groups">
                        <input 
                            ...
                            id={option.id}
                            key={index} 
                            checked={onlyLabel ? option.price == input.value : option.price+option?.suptag === input.value}
                            onChange={()=>onChange( onlyLabel ? option.price : option.price+option?.suptag)}
                        />
