            ...
            <div className="modal-dialog modal-custom-dailog" style={{marginTop:"40px"}}>
                <div className="modal-content" style={{backgroundColor: "black",width:"340px",borderRadius:"10px" }}>
                    ...
                    <div className="modal-header p-0" style={{ borderBottom: "none" }}>
                        <button type="button" className="btn-close btn-custom" data-bs-dismiss="modal" aria-label="Close" onClick={toggle}>
                            <Image
                                src={close1}
                                alt="user image"
                                width={32}
                    ...
                    <div className="modal-body">
                        <div className="sidebar_wrap">
                            ...
                            <div className="user-card-sidebar">
                                <div className="sidebar_nav_links " style={{paddingTop:"15px"}}>
                                    <ul>
                                      <li>
                                       <Link href="/">
                                     <a>
