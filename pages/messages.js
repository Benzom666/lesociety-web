                                                ...
                                                <div className="user-list-wrap">
                                                    <ul> 
                                                        ...
                                                        <li className="unread">
                                                            ...
                                                            <span className="user-details">
                                                                <h3>Mat Daemon <span className="unread_indicator"></span></h3>
                                                            </span>
                                                        </li>
                                                        <li>
                                                            <figure>
                                        ...
                                        <div className="message-chat-wrap">
                                            <div className="top-head">
                                                ...
                                                <div className="user-details">
                                                    ...
                                                    <h4 className="price_per_hour">$80 / <span>2hr</span></h4>
                                                    <div className="action_btn_list">
                                                        <span onClick={toggleClass}>
                                                            <BiDotsHorizontalRounded size={35} color={'rgba(255, 255, 255, 0.7)'} />
                                                        </span>
                                                    ...
                                                    <ul>
                                                        <li className="send">
                                                            <div className="message_content">
                                                                 <span className="message_time">2 minutes ago</span>
                                                                Hi Sana   
                                                            </div>
                                                        </li>
                                                        <li className="receive">
                                                            <div className="message_content">
                                                                <span className="message_time">0 minutes ago</span>
                                                                Hello John  
                                                            </div>
                                                        </li>
                                                        <li className="send">
                                                            <div className="message_content">
                                                                 <span className="message_time">2 minutes ago</span>
                                                                Hello I am testing the message content and verigy all category and  kfj  fnwejweour
                                                            </div>
                                                        </li>
                                                        <li className="receive">
                                                            <div className="message_content">
                                                                <span className="message_time">0 minutes ago</span>
                                                                I am testing the message content and verigy all category and  kfj  fnwejweour  
                                                            </div>
                                                        </li>
                                                        <li className="send">
                                                            <div className="message_content">
                                                                 <span className="message_time">2 minutes ago</span>
                                                                Hello I am testing the message content and verigy all category esting the message content and verigy all category and  kfj  fnwejweour
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
